...
void qcross(const float *q1, const float *q2, float *cross)
{
	cross[3]=q1[3]*q2[3] - q1[0]*q2[0] - q1[1]*q2[1] - q1[2]*q2[2];
	cross[0]=q1[3]*q2[0] + q1[0]*q2[3] + q1[1]*q2[2] - q1[2]*q2[1];
	cross[1]=q1[3]*q2[1] - q1[0]*q2[2] + q1[1]*q2[3] + q1[2]*q2[0];
	cross[2]=q1[3]*q2[2] + q1[0]*q2[1] - q1[1]*q2[0] + q1[2]*q2[3];
 ...
 */
void
build_rotmatrix(float* m, float q[4])
{
